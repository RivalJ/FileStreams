...
import FileTools.FileSaver;
import Objects.Product;

public class ProductFileSaver {
    ...
    public static void WriteProductToFile(Product product, RandomAccessFile file, boolean closeOnFinish) {
        try{
